...
class Paypal {
   ...
   */
   function Paypal() {
      ...
      $this->ipn_log_file = BASEPATH.'logs/ipn_results.log';
      $this->ipn_log = TRUE;
      $this->ipn_response = '';
   ...
   */
   ...
   function get_submit_paypal_post() {
     ...
     $result .= "<center>If you are not automatically redirected to ";
     $result .= "paypal within 5 seconds...\n";
     $result .= "<input type=\"submit\" value=\"Click Here\"></center>\n";
